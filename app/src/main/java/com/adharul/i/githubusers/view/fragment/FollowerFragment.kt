...
class FollowerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        username?.let { followerCode(it) }
        recyclerViewCode()
    }

    private fun followerCode(username: String) {
        detailViewModel.setFollowerList(username)
    }
    ...
    private fun recyclerViewCode() {
        ...
        detailViewModel.getFollowerList().observe(viewLifecycleOwner, Observer { listUsers ->
            if (listUsers != null) {
        ...
        detailViewModel.getErrorFollower().observe(viewLifecycleOwner, Observer { error ->
            mErrorDetails = error
        ...
        rvFollower.adapter = searchRecyclerViewAdapter

        searchRecyclerViewAdapter.setOnItemClickCallback(object :
